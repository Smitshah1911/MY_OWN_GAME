...
function bottle1() {
  ...
  bottleGroup.add(b1);  
 ///  b1.debug = true;
 b1.setCollider("rectangle", 0, 0, 20, 90, -40);
   b1.velocityX = (6 + 3*score/10);
...
function bottle2() {
  ...
  bottleGroup.add(b2);
  // b2.debug = true;
 b2.setCollider("rectangle", 0, 0, 20, 90, -40);
   b2.velocityX = (6 + 3*score/10);
}
...
function bottle3() {
  ...
  b3.scale = 0.3;
   bottleGroup.add(b3);  
 //  b3.debug = true;
 b3.setCollider("rectangle", 0, 0, 20, 90, -40);
   b3.velocityX = (6 + 3*score/10);
}
...
function bottle4() {
 ...
 bottleGroup.add(b4);  
 //  b4.debug = true;
 b4.setCollider("rectangle", 0, 0, 20, 90, -40);
   b4.velocityX = (6 + 3*score/10);
}
